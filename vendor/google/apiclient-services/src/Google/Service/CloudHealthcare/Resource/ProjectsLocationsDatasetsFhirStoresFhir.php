...
class Google_Service_CloudHealthcare_Resource_ProjectsLocationsDatasetsFhirStoresFhir extends Google_Service_Resource
{
   ...
   * operation accepts an additional query parameter `max`, which specifies N, the
   * maximum number of Observations to return from each group, with a default of
   * 1.
   *
   ...
   * the search parameters that are supported on each FHIR resource. For the list
   * of search parameters for STU3, see the [STU3 FHIR Search Parameter
