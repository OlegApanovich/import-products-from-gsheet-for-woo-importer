...
Full instruction about plugin options you can find on [our github plugin page](https://github.com/OlegApanovich/woocommerce-import-products-google-sheet) or in a section with screenshots below.
...
4. Full instruction about plugin options you can find on [our github plugin page](https://github.com/OlegApanovich/woocommerce-import-products-google-sheet)

== Frequently Asked Questions ==

= Where I can get "Google drive API client_secret json" for a plugin settings  =

Instructions about plugin options you can find on [our github plugin page](https://github.com/OlegApanovich/woocommerce-import-products-google-sheet)
...
[See the release history.](https://github.com/OlegApanovich/woocommerce-import-products-google-sheet/releases)